...
#bFirstSet.openText span {line-height: 14px;padding-left: 21px;}
#bPrevSet.openText {margin-right: 46px;}
#bPrevSet.openText span {line-height: 14px;padding-left: 13px;}
#bNextSet.openText {margin-right: 28px;}
#bNextSet.openText span {line-height: 14px;padding-left: 12px;}
#bLastSet.openText {margin-right: 28px;}
#bLastSet.openText span {line-height: 14px;padding-left: 21px;}
...
div.browseWrap input {margin-top:0;margin-bottom:0;}
...
.BrowseBodySelected[detailrow] td, .bbSelected {zoom:1;color:#444444;
        background: #9cbbd6;background: url(data:image/svg+xml;base64,);background: -moz-linear-gradient(top, #9cbbd6 0%, #6c88a2 100%);background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,#9cbbd6), color-stop(100%,#6c88a2));background: -webkit-linear-gradient(top, #9cbbd6 0%,#6c88a2 100%);background: -o-linear-gradient(top, #9cbbd6 0%,#6c88a2 100%);background: -ms-linear-gradient(top, #9cbbd6 0%,#6c88a2 100%);background: linear-gradient(to bottom, #9cbbd6 0%,#6c88a2 100%);
}
...
.EI2{font-weight:normal;font-size:9pt;border-style:solid;border-width:1px;border-color:#7F9DB9;position:absolute;z-index:0;top:2px;left:-1px;zoom:1;}
.EI3{font-weight:normal;font-size:9pt;border-style:solid;border-width:1px;border-color:#7F9DB9;position:absolute;z-index:0;top:22px;left:-1px;zoom:1;}
...
@-moz-document url-prefix() { .EditSelectFixed{padding:1px;} }
...
.themeLight{color:#123479;background-color:#D6E6FF;}.themeLight{color:#123479;background-color:#D6E6FF;}
...
td.monthYear{color:#000000;font-family:Arial,Helvetica,Sans-serif;font-size:11px;
        background: #99B7D6;background: url(data:image/svg+xml;base64,);background: -moz-linear-gradient(top, #639bd3 0%, #99b7d6 100%);background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,#639bd3), color-stop(100%,#99b7d6));background: -webkit-linear-gradient(top, #639bd3 0%,#99b7d6 100%);background: -o-linear-gradient(top, #639bd3 0%,#99b7d6 100%);background: -ms-linear-gradient(top, #639bd3 0%,#99b7d6 100%);background: linear-gradient(to bottom, #639bd3 0%,#99b7d6 100%);
}
